...
class RoomDetailsPageView extends StatelessWidget {
  const RoomDetailsPageView({
    ...
    required this.room,
    super.key,
    required Map<String, DeviceState> roomDeviceStates,
    required Null Function(dynamic deviceId, dynamic value) onDeviceToggle,
    required Null Function(dynamic deviceId, dynamic intensity)
    onIntensityChange,
    required Null Function(dynamic deviceId, dynamic temperature)
    onTemperatureChange,
    required Null Function(dynamic deviceId, dynamic fanSpeed) onFanSpeedChange,
    required Null Function(dynamic deviceId, dynamic mode) onModeChange,
  });
                    ...
                    SlideTransition(
                      ...
                      child: FadeTransition(
                        ...
                        child: Row(
                          children: [
                            Expanded(
                              child: LightsAndTimerSwitchers(
                                room: room,
                                roomDeviceStates: {},
                                onDeviceToggle:
                                    (String deviceId, bool value) {},
                              ),
                            ),
                            width20,
