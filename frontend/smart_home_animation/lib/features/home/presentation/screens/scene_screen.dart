...
class _SceneScreenState extends State<SceneScreen>
  ...
  List<SmartScene> _scenes = [
    ...
    SmartScene(
      id: '3',
      name: 'Good Night',
      description: 'Turn off lights, lock doors',
      icon: Icons.bedtime,
      color: Colors.indigo,
      deviceCount: 8,
      isFavorite: false,
    ...
    SmartScene(
      id: '4',
      name: 'Away Mode',
      description: 'Turn off all devices, enable security',
    ...
    SmartScene(
      id: '5',
      name: 'Dinner Time',
      description: 'Set dining lights to warm',
    ...
    SmartScene(
      id: '6',
      name: 'Reading Mode',
      description: 'Brighten reading corner',
    ...
    SmartScene(
      id: '7',
      name: 'Party Mode',
      description: 'Colorful lights, music on',
    ...
    SmartScene(
      id: '8',
      name: 'Focus Mode',
      description: 'Productivity lighting',
